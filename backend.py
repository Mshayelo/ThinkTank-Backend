...
def chatbot_query(user_input):
    ...
    Always provide specific, relevant information      
      If user asked for a summary then give a general summary(Include scope & purpose). Then extract , focus on these:
      - Technology Specs
    ...
    if user did not ask for a summary then be flexible and answer specifically what they wanted
    ...
    try:
        ...
        response = client_with_extensions.chat.completions.create(
            ...
            max_tokens=1000,
            messages=[
                {"role": "system", "content": "You an AI Assistant that answer using Azure Cognitive Search and OpenAI."},
